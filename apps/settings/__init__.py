...
class Config(object):
    ...
    # 设置密钥，可以通过base64.b64encode(os.urandom(48)) 来生成一个指定长度的随机字符串
    SECRET_KEY = "T1vEjTCjkGon5vU8C6Xq3ujNSQgHQje"

    # 配置日志
    LOG_LEVEL = "DEBUG"
    LOG_FILE_PATH = os.path.join(os.path.dirname(BASE_DIR), "logs/mogu.log")
    LOG_FILE_SIZE = 300 * 1024 * 1024
    LOG_FILE_NUMBER = 10

    # 数据库的配置信息
    SQLALCHEMY_DATABASE_URI = "mysql://root:123@127.0.0.1:3306/moguapp?charset=utf8"
    ...
    # session 配置
    SESSION_TYPE = 'redis'  # 指定 session 保存到redis
